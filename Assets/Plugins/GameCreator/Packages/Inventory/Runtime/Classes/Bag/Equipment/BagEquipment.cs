...
namespace GameCreator.Runtime.Inventory
{
    ...
    public class BagEquipment : IBagEquipment, ISerializationCallbackReceiver
    {
        ...
        public int Count
        {
            get
            {
                if (this.m_Equipment == null) return -1;
                return this.m_EquipmentRuntime != null
        ...
        public async Task<bool> EquipToIndex(RuntimeItem runtimeItem, int index)
        {
            ...
            bool isEquipSuccess = await runtimeItem.Equip();
            if (isEquipSuccess) runtimeSlot.Equip(this.Bag, slot.Bone, runtimeItem);
